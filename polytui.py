...
class PolyTUIScreen(Screen):
    ...
    def compose(self) -> ComposeResult:
        ...
        yield Horizontal(
            ...
            ScrollableContainer(
                Static("Loading markets...", id="market-list"),
                id="market-panel",
            ),
            # Center panel - Market details
            ScrollableContainer(
                Static("Select a market to view details", id="market-detail"),
                id="detail-panel",
            ),
            # Right panel - Order book and Trade
            ScrollableContainer(
                Static("Order Book", id="orderbook"),
                id="orderbook-panel",
            ),
            id="main-content",
        )
        ...
        # Status bar
        yield Static("| Ready. Press 'q' to quit, 'r' to refresh, '/' to search.", id="status")
